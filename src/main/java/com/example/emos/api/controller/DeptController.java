...
public class DeptController {
    ...
    public R searchDeptByPage(@Valid @RequestBody SearchDeptByPageForm form) {
        ...
        HashMap param = JSONUtil.parse(form).toBean(HashMap.class);//将form类转化成hash对象
        param.put("start", start);//更新数据
        PageUtils pageUtils = deptService.searchDeptByPage(param);//获取数据
